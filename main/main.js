...
function bestCharge(selectedItems) {
    ...
    const allItemsInfo = items.loadAllItems()
    const allpromotionItems = promotions.loadPromotions()
...
===================================`
  ...
  module.exports = {
    ...
    formatSelectedItems,
    getEachdishesInfo,
    calculateEachdishesSubtotal,
    getBestPromotionTypeAndSavemoney,
    promotionOfEach30cut6,
    promotionOfHalfPrice,
    getEachdishesDiscount,
    calculateTotalMoney
  }